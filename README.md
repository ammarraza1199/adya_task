...
Designed for scalability and operational minimum-friction, the system interprets employee intents and manager commands using Natural Language Processing (via **Groq Llama 3.1** models). The middleware precisely maps these conversational intents into strict parameterized tool executions, generating dynamic React User Interfaces (components) as chat responses.
...
5. [**Installation & Deployment Guide**](./INSTALLATION.md) - Developer instructions to boot the system natively.
